          ...
          <div className="iphone-status-bar">
            ...
            <div className="iphone-status-icons">
              ...
              <svg width="25" height="12" viewBox="0 0 25 12" fill="#000">
                <rect x="0.5" y="0.5" width="21" height="11" rx="3.5" stroke="#000" strokeOpacity="0.35" fill="none"/>
                <rect x="2" y="2" width="17" height="8" rx="2"/>
                <path d="M23 4V8C24 7.5 24.5 7 24.5 6C24.5 5 24 4.5 23 4Z" fill="#000" opacity="0.4"/>
              </svg>
            </div>
          </div>
